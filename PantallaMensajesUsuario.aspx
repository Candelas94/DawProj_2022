<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PantallaMensajesUsuario.aspx.cs" Inherits="Guitarras.PantallaMensajesUsuario" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/Scripts/mensajesusuario.js"></script>                                                 <%--JS PAGINA ACTUAL--%>
...
<body class="cuerpo_pagina">
    ...
    <div class="container mt-3">
        <div class="row d-flex justify-content-left" id="box_chat">            
        </div>
    </div>
