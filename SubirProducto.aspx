<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubirProducto.aspx.cs" Inherits="Guitarras.SubirProducto" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/Scripts/subir_producto.js"></script>                                                 <%--JS PAGINA ACTUAL--%>
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form id="formulario_foto" class="requires-validation" method="post" EncType="multipart/form-data">
                       <%-- <form id="form_subir" class="requires-validation" novalidate>--%>

                            <div class="col-md-12 mt-10">
                           <%-- <button type="button" id="abrir_fotos" >Subir imágenes</button>--%>
                            Sube una o varias imagenes: <input  id="oFile" type="file" NAME="oFile" multiple>
                            </div>

                            <div class="col-md-12">
                                <label for="name">Precio:</label>
                               <input id="precio_producto" class="form-control" type="text" name="precio" required>                              
                            </div>

                            <div class="col-md-12">
                                <label for="email">Marca:</label>
                                <input id="marca_producto" class="form-control" type="text" name="marca" required>
                            </div>                           


                           <div class="col-md-12">
                               <label for="password">Modelo:</label>
                              <input id="modelo_producto" class="form-control" type="text" name="modelo" required>
                           </div>     
                            ...
                            <div class="col-md-12">
                              ...
                              <input id="anyo_producto" class="form-control" type="text" name="anyo" required>
                           </div>    

                            <div class="col-md-12">
                               <label for="estado_product">Estado:</label>
                              <input id="estado_product" class="form-control" type="text" name="estado" required>
                           </div>
                          ...
                          <%-- <input id="id_producto_foto" type="hidden" name="id_producto" />
                            <input id="id_usuario_form" type="text" class="oculto" name="id_usuario_form" />--%>
                  
                            <div class="form-button mt-3">

                                <%--<button id="subir_producto" type="submit" class="btn btn-primary">Subir</button>--%>
